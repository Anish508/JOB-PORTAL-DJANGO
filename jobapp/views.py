...
def contactView(request):
    if request.method == 'POST':
        ...
        email_msg = EmailMessage(subject, full_message, to=['anishsdmcbm@gmail.com'])
        ...
        try:
            email_msg.send()
            return render(request, 'jobapp/contact.html', {'message': 'Message sent successfully!'})
        except Exception as e:
            print(e)  # Optional: log the error
            return render(request, 'jobapp/contact.html', {'message': 'Failed to send message. Please try again.'})
